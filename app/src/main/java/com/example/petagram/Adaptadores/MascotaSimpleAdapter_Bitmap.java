...
public class MascotaSimpleAdapter_Bitmap extends SimpleAdapter{
    ...
    public MascotaSimpleAdapter_Bitmap(Context context, List<? extends Map<String, ?>> data, // if fails to compile, do the same replacement as above on this line
